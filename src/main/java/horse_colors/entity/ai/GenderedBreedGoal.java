...
public class GenderedBreedGoal extends BreedGoal {
    ...
    */
    ...
    protected void spawnBaby() {
        ...
        if (!(this.animal instanceof IGeneticEntity) || !(this.field_75391_e instanceof IGeneticEntity)) {
            super.spawnBaby();
            return;
        }
        IGeneticEntity geneticAnimal = (IGeneticEntity)this.animal;
        IGeneticEntity geneticMate = (IGeneticEntity)this.field_75391_e;
        ...
        if (cancelled) {
            ...
            this.field_75391_e.setGrowingAge(geneticMate.getRebreedTicks());
        ...
        if (HorseConfig.isPregnancyEnabled()) {
            if (geneticAnimal.setPregnantWith(ageableentity, this.field_75391_e)) {
                ageableentity = null;
