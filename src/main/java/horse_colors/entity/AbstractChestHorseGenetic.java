...
public abstract class AbstractChestHorseGenetic extends AbstractHorseGenetic {
   private static final DataParameter<Boolean> DATA_ID_CHEST = EntityDataManager.createKey(AbstractChestHorseGenetic.class, DataSerializers.BOOLEAN);

   protected AbstractChestHorseGenetic(EntityType<? extends AbstractChestHorseGenetic> type, World worldIn) {
      super(type, worldIn);
