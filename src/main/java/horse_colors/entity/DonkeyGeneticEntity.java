...
public class DonkeyGeneticEntity extends AbstractChestHorseGenetic {
   ...
   public boolean canMateWith(AnimalEntity otherAnimal) {
      if (otherAnimal == this) {
         return false;
      } else if (!(otherAnimal instanceof DonkeyGeneticEntity) && !(otherAnimal instanceof HorseGeneticEntity)
                && !(otherAnimal instanceof DonkeyEntity) && !(otherAnimal instanceof HorseEntity)) {
         return false;
      } else {
