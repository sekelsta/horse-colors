...
public class HorseAlleles
{
    ...
    public static final int KIT_FLASHY_WHITE = 8;
    public static final int KIT_DRAFT_SABINO = 9;
    // In case I want to add another pattern later
    public static final int KIT_WILDTYPE_RESERVED = 10;
